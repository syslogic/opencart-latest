...
<div style="width: 100%; display: inline-block;">
  <div style="float: left; width: 569px;">
    <div class="warning">Don't forget to delete your installation directory via SSH!</div>
    <p>Congratulations! You have successfully deployed OpenCart to PagodaBox.</p>
